        ...
        <div className="grid grid-colis-1 lg:grid-cols-2 gap-8 px-4 lg:px-8 justify-center ">
          <div className="flex flex-col items-center gap-4 md:gap-6">
            <div className="w-full flex items-center justify-center ">
              <img src={img2} alt="bg info" className="w-[320px] h-[208px] lg:w-[640px] lg:h-[415px]" />
            </div>
            <div className="flex flex-col justify-center py-4  gap-4 w-[320px] h-[98px] lg:w-[640px] lg:h-[196px]">
              <h2 className="text-sm lg:text-base font-semibold  lg:py-6 font-sora">
