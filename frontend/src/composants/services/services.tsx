...
const Services = () => {
  return (
    <section className="w-full lg:px-35 flex items-center justify-center ">
      <div
        className=" h-auto w-full rounded-2xl py-8 lg:py-8 flex items-center  flex-col"
        style={{
          background: "linear-gradient(180deg, #F9F9F9 0%, #b4c9ed 100%)",
        }}
      >
        ...
        {/* grid justify-center gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 px-4 lg:px-8  w-full #123f65*/}
        <div className=" grid justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-x-6 gap-5 lg:gap-6 px-6 lg:px-4 ">
         
          <div className="w-full lg:w-[320px] lg:h-[390px] flex flex-col  gap-4 px-4 py-4 lg:px-8 bg-white rounded-2xl hover:shadow-gray-400 hover:shadow-lg transition-shadow duration-400 cursor-pointer">
            <div className="flex flex-col gap-3">
              ...
              <h1 className="text-title font-semibold text-lg">
               ...
               <p className="text-justify text-sm lg:text-sm text-black/80">
            ...
            <ul className="flex flex-col text-sm lg:text-sm gap-2">
          ...
          <div className="w-full lg:w-[320px] lg:h-[390px] flex flex-col  gap-4 px-4 py-4 lg:px-8 bg-white rounded-2xl hover:shadow-gray-400 hover:shadow-lg transition-shadow duration-400 cursor-pointer">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-start text-sm lg:text-sm text-black/80">
          ...
          <div className="w-full lg:w-[320px] lg:h-[390px] flex flex-col  gap-4 px-4 py-4 lg:px-8 bg-white rounded-2xl hover:shadow-gray-400 hover:shadow-lg transition-shadow duration-500 cursor-pointer">
            <div className="flex flex-col gap-3">
              <div className="pt-4">
